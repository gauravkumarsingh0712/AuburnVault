...
public class GlobalConstants {
    ...
    //Auburn Vault Twitter App Keys
    public static final String TWITTER_CONSUMER_KEY = "dV3XXqo24fuhXMLGLx62x0wre";
    public static final String TWITTER_CONSUMER_SECRET = "cj2niLZRDx3PrpPmKO8HhS2NBHkJHjYeg9ejpIr6K3spKc63jK";

    public static final int APP_ID = 2;
    public static final String APP_NAME = "auburnvault";
    public static final String APP_VERSION = "1.8.1";
    public static final String DEVICE_TYPE = "Android";
    public static final String APP_FULL_NAME = "Auburn Vault";
    public static final String APP_SCHOOL_NAME = "Auburn";

    // --------Banner image url-----------
    public static final String URL_FEATUREDBANNER = "http://www.ncsavault.com/banner/aub/gfeatured.png";
    public static final String URL_GAMESBANNER = "http://www.ncsavault.com/banner/aub/ggames.png";
    public static final String URL_OPPONETSBANNER = "http://www.ncsavault.com/banner/aub/gopponents.png";
    public static final String URL_PLAYERSBANNER = "http://www.ncsavault.com/banner/aub/gplayers.png";
    public static final String URL_COACHESBANNER = "http://www.ncsavault.com/banner/aub/gcoaches.png";
    public static final String URL_FAVORITESBANNER = "http://www.ncsavault.com/banner/aub/gfavorites.png";
    ...
    public static final String PROJECT_ID = "40276378349678";
    ...
    public static final String FEEDBACK_ASSIGNEE_NAME = "Brian Chimiklis";
    public static final String CLIP_REQUEST_ASSIGNEE_NAME = "Brian Chimiklis";
    ...
    // -------flurry key-----------
    public static final String FLURRY_KEY = "D586DCDMT8SPNCHPZ92T";  //Flurry Key For AuburnVaultAndroid app on Flurry Dashboard

    public static final String PREF_PACKAGE_NAME = "com.auburn.android";

    // Google project id
    public static final String GOOGLE_SENDER_ID = "466423093218";  // Place here your Google project id

    public static final String PROFILE_PIC_DIRECTORY = "AuburnVaultProfilePic";

    public static final String HOCKEY_APP_ID = "2799527e634c8f28e62592fd1c4d4d93";

    public static final String MAIL_CHIMP_LIST_ID = "41f059687a";
    /***********************************************************************************************
     ***********************************************************************************************/
    ...
    public static final String DO_YOU_WANT_TO_JOIN_OUR_MAILING_LIST = "We won't spam you, or sell your email. We simply want to keep informed about whats going on at AUBURN VAULT.\n";
    ...
    public static final String UGA_VAULT_PERMISSION = "Allow Auburn Vault to access photos,media,files and location on your device. Please go to app settings and allow permissions.";
    public static final String UGA_VAULT_RWAD_PHONE_STATE_PERMISSION = "Allow Auburn Vault to access read phone state on your device. Please go to app settings and allow permission.";
